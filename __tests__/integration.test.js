...
const {
    ...
    topicData,
    userData,
} = require(`${__dirname}/../db/data/test-data/index`);
...
describe("/api/articles", () => {
    ...
    test("GET: 200 responds with the correct array of objects when passed a query that relates to another table", () => {
        return request(app)
